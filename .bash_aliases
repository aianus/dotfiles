...
alias enable-repo-creation="curl -v --request PUT --header \"PRIVATE-TOKEN: $GITLAB_ACCESS_TOKEN\" --url 'https://gitlab.com/api/v4/groups/616049?project_creation_level=developer'"
